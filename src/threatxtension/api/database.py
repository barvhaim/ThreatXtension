"""
SQLite Database Module for ThreatXtension
...
class Database:
    ...
    def init_database(self):
        ...
        with self.get_connection() as conn:
            ...
            # Add batch_id as a nullable column on scan_results (SQLite can't
            # ALTER TABLE ADD FOREIGN KEY directly). Guarded so it runs once.
            cursor.execute(
                """
