...
from threatxtension.llm.clients.provider_type import LLMProviderType
...
def _get_base_llm_settings(model_name: str, model_parameters: Optional[Dict]) -> Dict:
    ...
    if LLM_PROVIDER == LLMProviderType.RITS:
        ...
        # GPT-OSS API only supports standard OpenAI parameters
        # Don't pass repetition_penalty, top_k in extra_body as they cause 422 errors
        return {
